...
export function Contact() {
    ...
    const contacts = [
        {
            name: "WhatsApp",
            description: "+55 71 9.9976-8805",
            link: "https://wa.me/5571999788805?text=Olá...",
            icon: <FaWhatsapp className="h-10 w-10" />
        },
        {
            name: "Email",
            description: "alissonlinsbispo@gmail.com",
            link: "mailto:alissonlinsbispo@gmail.com?subject=Olá...",
            icon: <HiOutlineEnvelope className="h-10 w-10" />
        },
        {
            name: "Salvador - BA",
            description: "Fazenda Grande 2",
            link: "https://www.google.com/maps/place/Salvador,+BA/@-12.9013789,-38.5845712,11z/data=!3m1!4b1!4m6!3m5!1s0x716112050422ebd:0xf71c84369573db9d!8m2!3d-12.9777378!4d-38.5016363!16s%2Fg%2F1ymsvkdl1?entry=ttu",
                        ...
                        <form ref={form} onSubmit={sendEmail}>
                            ...
                            <div className="mb-6 flex flex-col gap-4 md:flex-row">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <input
                                        className="w-full rounded-lg border border-white bg-trasparent p-2 outline-none"
                                        type="email"
                                        name="email"
                                        id="email"
                                        required
