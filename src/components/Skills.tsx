...
export function Skills () {
    const educations = [
        {
            name: "Curso de Programador de Sistemas | Senac",
        },
        {
            name: "Faculdade: Analise e Desenvolvimento de Sistemas | Centro Universitário Jorge Amado"
        }
    ]
    const skills = [
        {
        ...
        {
            name: "Node.js",
            icon: "https://cdn.worldvectorlogo.com/logos/nodejs-1.svg",
            level: 65,
        }
    ]
    return (
